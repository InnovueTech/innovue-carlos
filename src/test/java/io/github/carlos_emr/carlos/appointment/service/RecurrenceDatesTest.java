...
class RecurrenceDatesTest {
    ...
    @Test void monthlyDatesKeepTheOriginalDayAfterShortMonths() {
    ...
    @Test void yearlyDatesRecoverLeapDay() {
    ...
    @Test void weeklyRangeIsInclusiveAndDoesNotRoundUp() {
    ...
    @Test void rejectsZeroNegativeAndUnknownIntervals() {
    ...
    @Test void rejectsReversedAndExcessiveRangesBeforeReturningAnyDates() {
